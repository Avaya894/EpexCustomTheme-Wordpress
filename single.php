...
<div class="container my-5">
  <!-- <img class="w-100 my-3" src="https://api.time.com/wp-content/uploads/2020/07/never-trumpers-2020-election-01.jpg?quality=85&w=1201&h=676&crop=1" /> -->
  ...
  <div style="max-width: 700px; top: -80px;" class="mx-auto text-secondary position-relative">
    ...
    <h3 class="text-center font-weight-bold text-dark mt-4"><?php wp_title() ?></h3>
   <!-- <div>
        <small class="text-dark">
          Written by <?php bloginfo('author'); ?>
      </small>
    </div>  -->
    </div>
    
    <div class="my-2 lh-lg text-dark" style="color: #110e0e"><?php the_content() ?></div>
    <br>
    <br>
<!-- 
